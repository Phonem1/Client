...
import com.anewtech.phone.client.QuizActivity.Models.data.Answer;
import com.anewtech.phone.client.QuizActivity.Models.data.FinalMessage;
import com.anewtech.phone.client.QuizActivity.Models.data.Question;
import com.anewtech.phone.client.QuizActivity.Models.data.SurveyDataModel;
import com.anewtech.phone.client.QuizActivity.Models.data.Template;
...
public class SurveyDataService {
    ...
    public ArrayList<Questionaire> getFirstLayerQuestionaire(){ //First Layered Questions
        ...
        for (Question que: sm.layersquestions) {
            ...
            localnaire.correctAId = que.correctAnswerid;
